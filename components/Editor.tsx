           ...
           <div>
                <ul>
                    {analysisData.map(item => (
                        <li key={item.name} className=" px-3 py-5 flex items-center justify-between border-b border-t border-black/10">
                            <span className=" text-lg font-semibold">{item.name}</span>
                            <span className=" text-lg font-semibold px-3">{item.value}</span>
                        </li>
                    ))}
                </ul>
            </div>
